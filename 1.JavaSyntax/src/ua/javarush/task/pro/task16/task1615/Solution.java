...
public class Solution {
    ...
    static public Instant plusMinutes(Instant instant, long minutes) {
        ...
        Instant novui = Instant.ofEpochSecond((instant.getEpochSecond() + minutes * 60),instant.getNano());

        return novui;
    }

    static public Instant plusHours(Instant instant, long hours) {
        Instant novui = Instant.ofEpochSecond((instant.getEpochSecond() + hours * 3600 ),instant.getNano());
    ...
    static public Instant plusDays(Instant instant, long days) {
        //напишіть тут ваш код
        Instant novui = Instant.ofEpochSecond((instant.getEpochSecond() + days * 3600 * 24 ),instant.getNano());
