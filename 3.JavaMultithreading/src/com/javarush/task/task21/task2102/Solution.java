...
public class Solution {
    ...
    public static boolean isModifierSet(int allModifiers, int specificModifier) {
        String str = String.format("%8s",Integer.toBinaryString(allModifiers)).replaceAll(" ","0");
        //System.out.println(str);
        String str1 = String.format("%8s",Integer.toBinaryString(specificModifier)).replaceAll(" ","0");
